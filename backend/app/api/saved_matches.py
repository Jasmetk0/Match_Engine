...
def create_saved_match(payload: SavedMatchCreate, db: Session = Depends(get_db)):
    ...
    saved_match = SavedMatch(
        ...
        winner_profile_id=_int_or_none(winner.get("profile_id")),
        loser_profile_id=_int_or_none(loser.get("profile_id")),
        ...
        winner_name_snapshot=_required_str(winner.get("name"), "Winner"),
        loser_name_snapshot=_required_str(loser.get("name"), "Loser"),
